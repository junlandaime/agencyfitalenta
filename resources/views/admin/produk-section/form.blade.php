    ...
    <div class="max-w-3xl mx-auto">
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">{{ $produk->nama_produk }}</p>
            </div>
            <a href="{{ route('admin.produk.sections.index', $produk) }}" 
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <form action="{{ isset($section) 
                ? route('admin.produk.sections.update', [$produk, $section]) 
                : route('admin.produk.sections.store', $produk) }}" 
                  method="POST"
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <img src="{{ Storage::url('produk-sections/' . $section->image) }}" 
                             alt="{{ $section->title }}"
