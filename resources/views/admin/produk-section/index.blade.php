            ...
            <div class="min-w-full" x-data="{
                ...
                <div class="divide-y divide-gray-200">
                    <template x-for="(section, index) in sections" :key="section.id">
                        <div class="p-6 flex items-start space-x-4" :class="{ 'cursor-move': reorderEnabled }"
                         ...
                         ">
                            <div class="flex-1">
                                ...
                                <div class="mt-4 flex items-center space-x-4" x-show="!reorderEnabled">
                                    ...
                                    <form
                                        :action="'{{ route('admin.produk.sections.destroy', [$produk->id, '']) }}/' + section.id"
                            ...
                            <div x-show="section.image" class="flex-shrink-0 w-24">
                                <img :src="'/storage/produk-sections/' + section.image" :alt="section.title"
