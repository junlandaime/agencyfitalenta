...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-semibold text-gray-800">Sections - {{ $produkLayanan->nama_produk }}</h1>
            <p class="mt-1 text-sm text-gray-600">Kelola section untuk produk layanan ini</p>
        </div>
        <a href="{{ route('admin.produk-layanan.sections.create', $produkLayanan) }}" 
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="min-w-full" x-data="{ 
            ...
            async saveOrder() {
                try {
                    await axios.post('{{ route('admin.produk-layanan.sections.reorder', $produkLayanan) }}', {
                    ...
                    <div class="p-6 flex items-start space-x-4" 
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mt-4 flex items-center space-x-4" x-show="!reorderEnabled">
                                <a :href="'{{ route('admin.produk-layanan.sections.edit', [$produkLayanan->id, '']) }}/' + section.id"
                                   class="text-sm text-blue-600 hover:text-blue-900">Edit</a>
                                <form :action="'{{ route('admin.produk-layanan.sections.destroy', [$produkLayanan->id, '']) }}/' + section.id"
                                      method="POST"
                                      class="inline"
                        ...
                        <div x-show="section.image" class="flex-shrink-0 w-24">
                            <img :src="'/storage/sections/' + section.image" 
                                 :alt="section.title"
