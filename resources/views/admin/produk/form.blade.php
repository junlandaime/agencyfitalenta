                ...
                <form action="{{ isset($produk) ? route('admin.produk.update', $produk) : route('admin.produk.store') }}"
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <select name="produk_layanan_id" id="produk_layanan_id"
                        ...
                        <div>
                            ...
                            <select name="produk_category_id" id="produk_category_id"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    ...
                    <div x-data="itemManager('fitur', {{ json_encode(old('fitur', $produk->fitur ?? [])) }})">
                        <label class="block text-sm font-medium text-gray-700">Fitur</label>
                        <div class="mt-1 flex rounded-md shadow-sm">
                            <input type="text" x-model="newItem" @keydown.enter.prevent="addItem"
                    ...
                    <div x-data="itemManager('keunggulan', {{ json_encode(old('keunggulan', $produk->keunggulan ?? [])) }})">
                    ...
                    <div>
                        ...
                        <textarea name="catatan_produk" id="catatan_produk" rows="4"
                    ...
                    <div>
                        ...
                        <select name="status" id="status"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            <option value="draft"
                                {{ old('status', $produk->status ?? '') == 'draft' ? 'selected' : '' }}>Draft</option>
                            <option value="aktif"
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('alpine:init', () => {
                Alpine.data('itemManager', (name, initialItems = []) => ({
